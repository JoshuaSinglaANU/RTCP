...
(function() {
  //###########################################################################################################
  var $, $async, CND, FS, OS, PATH, PS, alert, badge, debug, echo, help, info, log, read, rpr, test, urge, warn, whisper;
  ...
  this["tee and stop events, 'collective' API"] = function(T, done) {
    ...
    sink_2_path = '/tmp/pipestreams-test-tee-2.txt';
    //.........................................................................................................
    sink_0 = PS.write_to_file(sink_0_path, function(error) {
      var file_contents;
      if (error != null) {
        throw error;
      }
    ...
    //.........................................................................................................
    sink_1 = PS.write_to_file(sink_1_path, function(error) {
      var file_contents;
      if (error != null) {
        throw error;
      }
    ...
    //.........................................................................................................
    sink_2 = PS.write_to_file(sink_2_path, function(error) {
      var file_contents;
      if (error != null) {
        throw error;
      }
    ...
    //.........................................................................................................
    pipeline_0 = [];
    pipeline_0.push(PS.new_value_source((function() {
      var i, results;
      results = [];
      for (n = i = 0; i <= 20; n = ++i) {
        results.push(n);
