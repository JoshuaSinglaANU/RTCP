...
(function() {
  //###########################################################################################################
  var $, $async, CND, FS, OS, PATH, SP, alert, badge, debug, echo, help, info, log, read, rpr, test, urge, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["tee and stop events, 'collective' API"] = function(T, done) {
    var $keep_even, $keep_odd, $link, n, pipeline_0, pipeline_1, pipeline_2, sink_0, sink_0_path, sink_1, sink_1_path, sink_2, sink_2_path, stream_1, stream_2, wait_count;
    wait_count = 3;
    //.........................................................................................................
    sink_0_path = '/tmp/pipestreams-test-tee-0.txt';
    sink_1_path = '/tmp/pipestreams-test-tee-1.txt';
    sink_2_path = '/tmp/pipestreams-test-tee-2.txt';
    //.........................................................................................................
    sink_0 = SP.write_to_file(sink_0_path, function(error) {
      var file_contents;
      if (error != null) {
        throw error;
      }
    ...
    //.........................................................................................................
    sink_1 = SP.write_to_file(sink_1_path, function(error) {
      var file_contents;
      if (error != null) {
        throw error;
      }
    ...
    //.........................................................................................................
    sink_2 = SP.write_to_file(sink_2_path, function(error) {
      var file_contents;
      if (error != null) {
        throw error;
      }
    ...
    $link = function(linker) {
      return SP.$map(function(value) {
        return (JSON.stringify(value)) + linker;
      });
    };
    $keep_odd = function() {
      return SP.$filter(function(number) {
        return number % 2 !== 0;
      });
    };
    $keep_even = function() {
    ...
    //.........................................................................................................
    pipeline_0 = [];
    pipeline_0.push(SP.new_value_source((function() {
      var i, results;
      results = [];
      for (n = i = 0; i <= 20; n = ++i) {
        results.push(n);
