...
(function() {
  ...
  this.seal = Symbol('steampipes');

  //===========================================================================================================

  //-----------------------------------------------------------------------------------------------------------
  this.remit = this.$ = function(...modifiers) {
    var arity, o, ref, ref1, send, t, transform;
    ...
    if (modifiers.length > 0) {
      return this.modify(...modifiers, transform);
    }
    o = [];
    send = sink.push;
    t = function(d, send) {
      return transform(d, send);
    };
    return {[ref1 = this.seal]: ref1, t, o, send};
  };
